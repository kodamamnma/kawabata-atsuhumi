          ...
          <div>
            ...
            {[
              ...
              },
              {
                ...
                text: '当サイトでは、Google によるアクセス解析ツール「Google アナリティクス」を利用しています。このツールはCookieを使用して、個人を特定する情報を含まない形でアクセスデータを収集します。この機能はブラウザの設定でCookieを無効にすることで収集を拒否できます。'
              },
              {
                title: '第5条（第三者配信の広告サービスについて）',
                text: '当サイトでは、第三者配信の広告サービス「Google AdSense」を利用しています。広告配信事業者は、ユーザーの興味に応じた広告を表示するためにCookieを使用することがあります。Cookieを無効にする方法や Google AdSense に関する詳細は、Google の広告設定ページをご覧ください。'
              },
              {

      ...
      <main style={{ maxWidth: 720, margin: '0 auto', padding: '40px 16px 80px' }}>
        ...
        <div style={{ marginBottom: 40, textAlign: 'center' }}>
          ...
          <div style={{ fontSize: 13, color: C.t2, lineHeight: 1.6 }}>
            鹿児島地域交通通信社（以下「私たち」）における個人情報の取り扱い方針です。
          </div>
        </div>
        ...
        <div style={{ background: C.white, borderRadius: 8, boxShadow: '0 2px 12px rgba(27,58,107,0.06)', padding: '40px 32px' }}>
          <p style={{ fontSize: 13, color: C.t2, lineHeight: 1.9, marginBottom: 24 }}>
            鹿児島地域交通通信社（以下「私たち」）は、ご利用者の個人情報の保護を重要な責務と認識し、以下のポリシーに従って適切に取り扱います。
          </p>
          {[
            { title: '個人情報の収集・利用', text: '私たちは、お問い合わせへの対応・サービス改善・記事品質向上のために必要な範囲で個人情報を収集することがあります。収集した情報は、目的以外の用途には使用しません。' },
            { title: '第三者への提供', text: '私たちは、法令に基づく場合を除き、ご本人の同意なく個人情報を第三者に提供・開示することはありません。' },
            { title: 'アクセス解析', text: '当サイトでは、サービス改善のためにアクセス解析ツールを使用する場合があります。収集データは個人を特定するものではありません。' },
            { title: '免責事項', text: '私たちが提供する情報は可能な限り正確な情報を掲載するよう努めておりますが、情報の正確性・安全性等を保証するものではありません。掲載情報による損害について、私たちは一切の責任を負いません。' },
